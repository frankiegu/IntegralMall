...
class CartManage extends React.Component {
  constructor(props) {
    super(props);
  ...
  orderAccount () {
    ...
    if (cart_id.length) {
      fetch(`http://0.0.0.0:8085/v1/api/carts`, {
        method: 'POST',
        headers: {
          'Accept': 'application/json',
          'Content-Type': 'application/json',
      ...
      <>
        ...
        <View style={styles.cartboxTool}>
          ...
          <View style={styles.cartboxToolRow}>
            ...
            >
              <Text allowFontScaling={false} style={{fontSize: 14, fontWeight: '500', color: '#FFF'}}>删除</Text>
            </TouchableHighlight>
          </View>
        </View>
      </>
