        ...
        <View>
          ...
          >
            ...
            <View style={iconStyle.iconContainer}>
              <Text allowFontScaling={false} style={styles.subTitle}>推荐</Text>
            ...
            <View style={iconStyle.iconContainer}>
              <Text allowFontScaling={false} style={styles.subTitle}>应用</Text>
            </View>
            <FlatList
                ...
                >
                  <>
                    ...
                    <View style={styles.lotteryFoot}>
                      <Text allowFontScaling={false} style={styles.lotteryLottery_name}>{item.lottery_name}</Text>
                      <View style={styles.lotteryFooter}>
                        <Text allowFontScaling={false} style={styles.lotteryFinish_quantity}>{'¥' + item.finish_quantity}</Text>
